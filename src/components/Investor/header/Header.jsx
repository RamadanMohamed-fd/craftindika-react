  ...
  return (
    ...
    >
      <nav className="h-[100px] w-[88%] m-auto  flex  items-center">
        <div
          data-aos="fade-right"
          className="  duration-500 cursor-pointer  text-2xl w-[58%] logo "
        >
          <span className=" u relative w-fit hover:text-[#c5a56f] duration-500">
            CRAFTINDIKA©
          </span>
        </div>
        <ul
          data-aos="fade-left"
          className="menu  w-fit text-sm   hidden   lg:flex justify-between items-center"
        >
