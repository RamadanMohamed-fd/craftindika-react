  ...
  return (
    <div className="flex justify-end items-center">
      ...
      <div
        ...
        }   fixed z-[1000] flex duration-500 text_header  items-start bg-white py-4 shadow-lg 
      ...
      >
        ...
        <ul
          className={`menu text-xl flex flex-wrap w-full bg-white justify-around items-center`}
        >
